    ...
    public partial class Form1 : Form
    {
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            foreach (string port in ports)
            {
                ...
                {
                    terminalTextBox.Invoke(this.myDelegate, "COM port open failed " + port + Environment.NewLine);
                }
            ...
            {
                 {
                    //Text = "UNO Canbus monitor V1.2";      // display connected message
        ...
        private void serialPort1_DataReceived(object sender, System.IO.Ports.SerialDataReceivedEventArgs e)
        {
            try
            {
                ...
                if (serialData.Contains("UNO Canbus monitor V1.2")) canbusMonitorFound = true;
            }
            catch (Exception e1) { }
        }
        ...
        public void AddDataMethod(String myString)
        {
            ...
            if (chars[0] == '>') 
            canbusReceivedMessageTextBox.AppendText(myString.Substring(1) + Environment.NewLine);
           // canbusReceivedMessageTextBox.AppendText(myString.Substring(0) + Environment.NewLine);
        }
